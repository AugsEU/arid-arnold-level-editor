namespace AridArnoldEditor
{
	partial class LevelEditor
	{
		...
		private void InitializeComponent()
		{
			...
			wEntityClassCombo.Items.AddRange(new object[] { "Arnold", "Androld", "Trundle", "Roboto", "FutronGun", "FutronRocket", "Farry", "Barbara", "Zippy", "Dok", "BickDogel", "Electrent", "ArnoldSpawner", "SequenceDoor", "LevelLock", "ShopDoor", "ItemStand", "GravityOrb", "GravityTile", "TimeMachine" });
