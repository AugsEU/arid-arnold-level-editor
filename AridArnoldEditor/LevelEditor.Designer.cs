namespace AridArnoldEditor
{
	partial class LevelEditor
	{
		...
		private void InitializeComponent()
		{
			...
			wEntityFP7.Minimum = new decimal(new int[] { 10000000, 0, 0, int.MinValue });
			...
			wEntityFP5.Minimum = new decimal(new int[] { 10000000, 0, 0, int.MinValue });
			...
			wEntityFP3.Minimum = new decimal(new int[] { 10000000, 0, 0, int.MinValue });
			...
			wEntityFP1.Minimum = new decimal(new int[] { 10000000, 0, 0, int.MinValue });
			...
			wEntityFP6.Minimum = new decimal(new int[] { 10000000, 0, 0, int.MinValue });
			...
			wEntityFP4.Minimum = new decimal(new int[] { 10000000, 0, 0, int.MinValue });
			...
			wEntityFP2.Minimum = new decimal(new int[] { 10000000, 0, 0, int.MinValue });
			...
			wEntityFP0.Minimum = new decimal(new int[] { 10000000, 0, 0, int.MinValue });
			...
			wEntityClassCombo.Items.AddRange(new object[] { "Arnold", "Androld", "Trundle", "Roboto", "FutronGun", "FutronRocket", "Farry", "Mamal", "Barbara", "Zippy", "Dok", "BickDogel", "Electrent", "ArnoldSpawner", "SequenceDoor", "LevelLock", "ShopDoor", "ItemStand", "GravityOrb", "GravityTile", "TimeMachine", "PlantPot", "PillarPot" });
		...
		private NumericUpDown wEntityIP6;
		private NumericUpDown wEntityIP4;
		private NumericUpDown wEntityIP2;
		private NumericUpDown wEntityIP0;
		private NumericUpDown wEntityFP7;
		private NumericUpDown wEntityFP5;
		private NumericUpDown wEntityFP3;
		private NumericUpDown wEntityFP1;
		private NumericUpDown wEntityIP7;
		private NumericUpDown wEntityIP5;
		private NumericUpDown wEntityIP3;
		private NumericUpDown wEntityIP1;
		private NumericUpDown wEntityFP6;
		private NumericUpDown wEntityFP4;
		private NumericUpDown wEntityFP2;
